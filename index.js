...
// Test raw network access to boot.pluto.tv
app.get('/debug/nettest', async function (req, res) {
  try {
    ...
    var hasToken = !!(r.data && r.data.sessionToken);
    sendJson(res, { ok: true, status: r.status, hasToken: hasToken, topKeys: Object.keys(r.data || {}).slice(0, 8) });
  } catch (e) {
